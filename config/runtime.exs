...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/courier/courier.db
      """
  ...
  # If SECRET_KEY_BASE is set, sessions persist across restarts.
  # If not set, a random key is generated on each startup — sessions are
  ...
  # Set PHX_SCHEME=https if running behind a TLS-terminating reverse proxy
